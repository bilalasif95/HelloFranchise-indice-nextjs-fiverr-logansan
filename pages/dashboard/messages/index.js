                  ...
                  <div className='chat-container' data-simplebar>
                    <div className='chat-content'>
                      <div className='chat'>
                        ...
                        <div className='chat-body'>
                          <div className='chat-message'>
                            <p>
                              👋Hi​! I'm a HelloFranchise. Let me know if you have any
                      ...
                      <div className='chat chat-left'>
                        ...
                        <div className='chat-body'>
                          <div className='chat-message'>
                            <p>Could you describe HelloFranchise in one sentence?</p>
                            <span className='time d-block'>7:45 AM</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className='chat chat-left'>
                        ...
                        <div className='chat-body'>
                          <div className='chat-message'>
                            <p>
                              What makes you different from other directory
                              platforms?
                            </p>
                            <span className='time d-block'>7:45 AM</span>
                          </div>
        ...
        <div className='copyrights-area'>
          <div className='row align-items-center'>
            <div className='col-lg-6 col-sm-6 col-md-6'>
              <p>
                <i className='bx bx-copyright'></i> HelloFranchise All
                rights reserved
              </p>
            </div>
            ...
            <div className='col-lg-6 col-sm-6 col-md-6 text-right'>
              <p>
                Designed by ❤️{' '}
                <a href='https://rapidstatup.io/' target='_blank' rel="noreferrer">
                  RapidStartup
                </a>
              </p>
            </div>
